...
/* harmony import */ var _AnimateFunctions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6);
/* harmony import */ var _ControlFunctions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);
/* harmony import */ var _DrawFunctions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8);
/* harmony import */ var _Levels__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9);
/* harmony import */ var shifty__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(12);
...
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(13);
...
const breatheAnimation = () => {
    const breathe = new shifty__WEBPACK_IMPORTED_MODULE_5__["Tweenable"]()
    const start = { x: 25 }
...
const pulseAnimation = () => {
    const pulse = new shifty__WEBPACK_IMPORTED_MODULE_5__["Tweenable"]()
    const start = { x: 0 }
    //let rad = 0
    const step = (state) => {
        rad = state.x
...
let wy = y
const warpAnimation = () => {
    const rifts = new shifty__WEBPACK_IMPORTED_MODULE_5__["Tweenable"]()
    const start = { x: wx, y: wy }

    const step = (state) => {
        wx = state.x
        wy = state.y
        Object(_DrawFunctions__WEBPACK_IMPORTED_MODULE_3__["drawRect"])(ctx, wx, wy, 5, 5, 'magenta')
    }
    const duration = 950
    const easing = 'linear'
    rifts.tween({
        from: start,
        to: { x: x + (25 * lodash__WEBPACK_IMPORTED_MODULE_6___default.a.random(-1, 1)), y: y + (25 * lodash__WEBPACK_IMPORTED_MODULE_6___default.a.random(-1, 1)) },
        step,
        duration,
        easing
    }).then(() => {
...
const backgroundStars = () => {
    let sx = lodash__WEBPACK_IMPORTED_MODULE_6___default.a.random(0, 1000)
    let sy = lodash__WEBPACK_IMPORTED_MODULE_6___default.a.random(0, 800)
    let sr = lodash__WEBPACK_IMPORTED_MODULE_6___default.a.random(3, 6)
    const stars = new shifty__WEBPACK_IMPORTED_MODULE_5__["Tweenable"]()
    const start = { x: sx, y: sy }

    const step = (state) => {
        sx = state.x
        sy = state.y
        Object(_DrawFunctions__WEBPACK_IMPORTED_MODULE_3__["drawCircle"])(ctx1, sx, sy, sr, 0, 2, true, 'yellow')
    }
    const duration = lodash__WEBPACK_IMPORTED_MODULE_6___default.a.random(30000, 100000)
    const easing = 'linear'
    stars.tween({
        from: start,
        to: { x: lodash__WEBPACK_IMPORTED_MODULE_6___default.a.random(-1000, 1000), y: lodash__WEBPACK_IMPORTED_MODULE_6___default.a.random(-1000, 1000) },
        step,
        duration,
        easing
    })
...
const movement = new shifty__WEBPACK_IMPORTED_MODULE_5__["Tweenable"]()
const move = () => {
...
Object(_AnimateFunctions__WEBPACK_IMPORTED_MODULE_1__["fpsTick"])(60, () => {
    let circle = {
        x: x,
        y: y,
        r: r
    ...
    Object(_DrawFunctions__WEBPACK_IMPORTED_MODULE_3__["clearCanvas"])(ctx, canvas)
    Object(_DrawFunctions__WEBPACK_IMPORTED_MODULE_3__["clearCanvas"])(ctx1, canvas1)
    if (Object(_ControlFunctions__WEBPACK_IMPORTED_MODULE_2__["checkCollision"])(circle, level)) {
        console.log(true)
    }
    if (scrollRight) {
        camera.x -= 5
    ...
    Object(_DrawFunctions__WEBPACK_IMPORTED_MODULE_3__["drawRect"])(ctx1, 0, 0, 1000, 800, 'black')
    Object(_DrawFunctions__WEBPACK_IMPORTED_MODULE_3__["drawRect"])(ctx, 500, 500, 100, 400, 'blue')
    Object(_DrawFunctions__WEBPACK_IMPORTED_MODULE_3__["drawCircle"])(ctx, x, y, r, 0, 2, true, 'blue')
    Object(_DrawFunctions__WEBPACK_IMPORTED_MODULE_3__["drawCircle"])(ctx, x, y, rad, 0, 2, true, 'white')
    ctx.restore()
})
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fpsTick", function() { return fpsTick; });
...
/* harmony import */ var _NarrativeFunctions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(10);


const levelOne = {
    init: () => {
        Object(_NarrativeFunctions__WEBPACK_IMPORTED_MODULE_0__["askQuestion"])("Hello, what is your name?")
        Object(_NarrativeFunctions__WEBPACK_IMPORTED_MODULE_0__["questionResponseHTML"])('freeText')
    }
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "questionResponseHTML", function() { return questionResponseHTML; });
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(11), __webpack_require__(14)(module)))
